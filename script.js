...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const questions = [
...

    {
...

      {
        ...
        correct: 0,
        feedback:
          "The g flag stands for global search, meaning it will search for all matches ina string, not just the first.",
      },

      {
        ...
        correct: 0,
        feedback:
          "The i flag is used to make the regular expression search case-insensitive.",
      },
...

      {
        ...
        correct: 0,
        feedback:
          "The ^ character matches the position at the beginning of the input.",
      },
      ...
      {
        question: "What is the purpose of parentheses ( ) in regular",
        answers: [
          "To define a searchable pattern.",
          "To specify optional characters",
          "To create a captue group",
          "To escape special character",
        ],
        correct: 2,
        feedback:
          "Parentheses are used to create a capture group in regular expressions",
      },

      {
        ...
        correct: 1,
        feedback:
          "The | symbol is used as a logical OR in regular expressions",
      },

      {
        ...
        correct: 1,
        feedback:
          "The ? makes the preceding token in the regular expression optional.",
      },
      ...
      correct: 0,
      feedback:
        "The + character matches one or more of the preceding element.",
    },

    {
...

      {
        ...
        answers: [
          "Any word character (letter, digit, underscores). ",
          "Any non-word character.",
          "Any whitespace character.",
...

      {
        ...
        correct: 2,
        feedback:
          " /(cat|dog)/ correctly uses the pipe | to match either 'cat' or 'dog'",
      },
  ...
  function checkAnswer(index) {
    ...
    answerItems[correctIndex].style.backgroundColor;
  ...
  function showResults() {
    document.getElementById("quiz-container").innerHTML = `<div id="results">
    <h2>Quiz Complete!</h2>
